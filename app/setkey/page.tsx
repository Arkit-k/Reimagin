...
export default function SetKeyPage() {
  ...
  return (
    <div className="container mx-auto mt-20 p-4 max-w-md">
      <h1 className="text- text-white font-bold mb-4">Set Google Gemini API Key</h1>
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray- text-white rounded-md focus:outline-none focus:ring-2 focus:ring-white"
          />
        </div>
        ...
        {savedKey && (
          <div className="mt-4">
            <p className="text-sm text-gray-600">Current API Key: {savedKey.slice(0, 10)}...</p>
